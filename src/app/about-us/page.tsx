              ...
              <StaggerItem key={i} className="h-full">
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute inset-0 [backface-visibility:hidden] [-webkit-backface-visibility:hidden] [transform:rotateY(0deg)] [-webkit-transform:rotateY(0deg)] rounded-2xl overflow-hidden shadow-[0_24px_50px_-24px_rgba(0,0,0,0.7)]">
                      {/* cover image */}
                    ...
                    {/* BACK — body */}
                    <div
                      className="absolute inset-0 [backface-visibility:hidden] [-webkit-backface-visibility:hidden] [transform:rotateY(180deg)] [-webkit-transform:rotateY(180deg)] rounded-2xl overflow-hidden p-7 flex flex-col shadow-[0_24px_50px_-24px_rgba(0,0,0,0.7)]"
                      style={{ background: `linear-gradient(150deg, ${b.from}, ${b.to})` }}
                    >
