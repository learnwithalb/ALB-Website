      ...
      <section className="bg-[#060c1a] pt-28 pb-12">
        <div className="container-max px-5 md:px-8">
          <AnimateOnView>
            ...
            <h1 className="text-4xl md:text-5xl font-black text-white mt-4">Terms & Conditions</h1>
      ...
      <section className="section-padding bg-[#060c1a]">
        <div className="container-max">
          <div className="max-w-3xl mx-auto">
            <AnimateOnView className="glass-blue border border-[#22C55E]/30 rounded-2xl p-5 mb-10">
              <p className="text-white/60 text-sm leading-relaxed">
                <strong>Important:</strong> Please read these Terms & Conditions carefully before enrolling
