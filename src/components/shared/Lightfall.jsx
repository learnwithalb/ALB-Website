...
const Lightfall = ({
  ...
  // keep `paused` live without tearing down & rebuilding the WebGL context
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const renderer = new Renderer({
      // cap DPR — this is a heavy full-screen shader; rendering at native retina DPR tanks scroll perf
