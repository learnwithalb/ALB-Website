...
export const FRENCH: CourseData = {
  ...
  ew: "French · For Immigration, Study & Career Growth",
  ...
  tracks: [
    ...
    { icon: "star", name: "Junior Track", color: "#D97706", pop: false, forText: "School students (Class 6–12) building early French proficiency for academic advantage, DELF certifications, and future university or immigration goals.", exams: ["DELF A1", "DELF A2", "DELF B1"] },
  ],
  journey: [
  ...
  curriculum: [
    { label: "Module 1", title: "Foundation", badge: "A1 · DELF A1", weeks: "8 Weeks", desc: "Build the confidence to communicate in everyday situations and establish a strong foundation in French pronunciation, grammar, and conversation.", topics: [
      { t: "Greetings, Introductions & Personal Identity", i: ["Formal and informal communication", "Introducing yourself and others", "Nationalities, professions, and personal information"] },
      { t: "Numbers, Dates & Everyday Communication", i: ["Time, dates, schedules, and appointments", "Basic transactions and daily interactions", "Essential question and answer structures"] },
      { t: "Family, Daily Life & Social Situations", i: ["Family and relationships", "Daily routines and habits", "Describing people, places, and preferences"] },
      { t: "Food, Shopping & Local Services", i: ["Ordering food and dining etiquette", "Shopping and service interactions", "Asking for directions and navigating public spaces"] },
    ...
    { label: "Module 2", title: "Everyday Confidence", badge: "A2 · DELF A2", weeks: "8 Weeks", desc: "Develop the ability to manage everyday situations independently. Learn to communicate in travel, study, work, and administrative environments while building confidence in speaking, listening, reading, and writing.", topics: [
      { t: "Travel, Transport & City Life", i: ["Travel planning and bookings", "Public transportation vocabulary", "Navigating cities and public services"] },
      { t: "Past Experiences & Storytelling", i: ["Talking about past events", "Describing experiences and achievements", "Narrating personal and professional journeys"] },
      { t: "Health, Housing & Daily Administration", i: ["Healthcare and appointments", "Accommodation and housing vocabulary", "Basic administrative communication"] },
    ...
    { label: "Module 3", title: "Real-World Communication", badge: "B1 · DELF B1 · TEF/TCF Foundation", weeks: "10 Weeks", desc: "Use French confidently in academic, professional, and social situations while learning to express ideas, opinions, and experiences effectively.", topics: [
      { t: "Work, Careers & Professional Communication", i: ["Workplace communication and etiquette", "Professional vocabulary and networking", "Business correspondence and meetings"] },
      { t: "Education, Universities & Academic Life", i: ["Academic vocabulary and university systems", "Presentations and classroom discussions", "Research and study-related communication"] },
      { t: "Society, Culture & Media", i: ["Current affairs and social topics", "Expressing opinions and arguments", "Cultural awareness across Francophone regions"] },
      { t: "Formal Communication & Exam Foundations", i: ["Official correspondence and documentation", "Introduction to TEF, TCF, and DELF exam formats", "Structured speaking and writing tasks"] },
    ...
    { label: "Module 4", title: "Advanced Fluency & Opportunity Readiness", badge: "B2 · DELF B2 · TEF Canada · TCF Canada", weeks: "10 Weeks", desc: "Achieve advanced communication skills for university admissions, professional environments, immigration pathways, and international opportunities.", topics: [
      { t: "Advanced Communication & Argumentation", i: ["Debate and structured discussion", "Persuasive communication", "Professional and academic presentations"] },
      { t: "Academic & Professional Writing", i: ["Essays, reports, and formal documents", "Research summaries and analytical writing", "Business communication and proposals"] },
      { t: "Advanced Grammar & Accuracy", i: ["Complex sentence structures", "Advanced verb forms and connectors", "Accuracy, coherence, and style"] },
      { t: "Exam Preparation & Real-World Application", i: ["DELF B2 preparation", "TEF Canada and TCF Canada readiness", "Mock interviews, presentations, and simulations"] },
    ...
    { label: "Module 5", title: "+Beyond, Global Confidence Program", badge: "Soft Skills · Complimentary", weeks: "2 Weeks", desc: "Develop interview skills, presentation abilities, professional communication, personal branding, and workplace confidence that go beyond language learning.", topics: [
      { t: "Personal Effectiveness & Communication", i: ["Confidence building", "Public speaking fundamentals", "Active listening and interpersonal skills"] },
  ...
  usps: [
    ...
    { i: "teacher", t: "Communication & Fluency Labs", b: "Build confidence through guided conversations, speaking drills, role plays, discussions, presentations, and real-world communication practice integrated throughout the programme." },
  ...
  comparison: [
    ...
    { f: "Communication skills", g: "Grammar and exams only", a: "Dedicated communication & fluency labs" },
    { f: "Exam preparation", g: "Sold as a separate add-on", a: "DELF, TEF & TCF prep built into the journey" },
  ...
  faq: [
    ...
    { q: "How long does it take to learn French from A1 to B2?", a: "At ALB, learners can progress from A1 to B2 in approximately 36 weeks through a structured pathway that combines language learning, communication practice, exam preparation, and confidence-building activities." },
    { q: "Which French exam should I take?", a: "The right exam depends on your goal. DELF is widely recognised internationally and suitable for academic and professional purposes. TEF Canada and TCF Canada are commonly used for Canadian immigration pathways. ALB helps learners choose the exam most relevant to their goals." },
    ...
    { q: "Can I learn French for Canada immigration?", a: "Yes. French language proficiency can contribute significantly to Canadian immigration applications. ALB's Immigration Track prepares learners for French language requirements relevant to immigration pathways and recognised language exams." },
...
export const ENGLISH: CourseData = {
  ...
  stats: [{ n: "22", l: "Teaching Weeks" }, { n: "132", l: "Instruction Hours" }, { n: "6", l: "Max Per Batch" }, { n: "3", l: "Learning Tracks" }, { n: "7.0+", l: "IELTS Band Target" }],
  sections: {
  ...
  curriculum: [
    { label: "Module 0", title: "Absolute Beginner Foundation", badge: "Pre-A1 Foundation", weeks: "4 Weeks", desc: "Designed for learners with little or no English exposure. Build the vocabulary, pronunciation, sentence structures, and speaking confidence required to begin your English journey successfully.", topics: [
      { t: "Alphabet, Sounds & First Words", i: ["English alphabet and phonics", "Basic pronunciation patterns", "Greetings and introductions"] },
      ...
      { t: "Readiness & Confidence", i: ["Role-play conversations", "Speaking confidence activities", "Module readiness assessment"] },
    ...
    { label: "A1", title: "Foundation Communication", badge: "A1 · Foundation Communication", weeks: "8 Weeks", desc: "Build the confidence to communicate about yourself, your routines, experiences, plans, and everyday situations using practical spoken and written English.", topics: [
      ...
      { t: "Daily Life & Routines", i: ["Time and schedules", "Habits and activities", "Everyday communication"] },
      { t: "People, Places & Experiences", i: ["Descriptions and directions", "Talking about past events", "Sharing experiences"] },
      { t: "Shopping & Information", i: ["Transactions and prices", "Asking questions", "Requests and enquiries"] },
    ...
    { label: "A2", title: "Practical Communication", badge: "A2 · Practical Communication", weeks: "8 Weeks", desc: "Develop the ability to manage real-world situations independently while improving fluency, confidence, speaking, listening, reading, and writing skills.", topics: [
      { t: "Travel & Everyday Situations", i: ["Travel planning and bookings", "Public transportation", "Directions and navigation"] },
      { t: "Discussions & Storytelling", i: ["Sharing opinions", "Describing experiences", "Structured conversations"] },
      { t: "Workplace & Daily Communication", i: ["Office communication", "Professional interactions", "Telephone conversations"] },
    ...
    { label: "B1", title: "Fluency & Professional Confidence", badge: "B1 · Fluency & Professional Confidence", weeks: "8 Weeks", desc: "Move beyond basic communication and develop the fluency, confidence, and professional communication skills required for interviews, presentations, meetings, and workplace success.", topics: [
      { t: "Advanced Conversations", i: ["Social and professional discussions", "Networking communication", "Confidence-building practice"] },
      { t: "Presentations & Public Speaking", i: ["Speech structure", "Presentation delivery", "Audience engagement"] },
      { t: "Interviews & Workplace Communication", i: ["Interview preparation", "Meetings and collaboration", "Professional communication"] },
  ...
  outcomes: [
    ...
    { i: "work", t: "Deliver presentations and lead meetings", s: "Executive presence, structured delivery, confident Q&A" },
  ...
  faq: [
    { q: "Who should join ALB's English programme?", a: "ALB's English programme is designed for students, working professionals, job seekers, study-abroad aspirants, IELTS candidates, and anyone who wants to improve their spoken and written English. Whether you're starting from the basics or aiming for advanced fluency, the programme follows a structured progression that helps learners communicate confidently in real-world situations." },
    { q: "How long does it take to improve spoken English?", a: "Most learners notice a significant improvement in confidence, vocabulary, and speaking ability within the first 8–12 weeks of consistent practice. The exact timeline depends on your starting level, learning goals, and participation. ALB's structured curriculum focuses on practical communication rather than memorisation, helping learners improve faster." },
    { q: "Can I join if my English is very weak?", a: "Yes. ALB offers a Beginner Foundation module specifically for learners with little or no confidence in English. The programme starts with pronunciation, vocabulary, sentence formation, and basic communication before progressing to more advanced levels." },
    { q: "Is this a spoken English course or a complete English programme?", a: "ALB is a complete English development programme. Students improve speaking, listening, reading, writing, pronunciation, communication confidence, workplace English, presentation skills, and interview readiness. The goal is not just to speak English, but to communicate effectively in academic, professional, and everyday situations." },
    { q: "How is ALB different from other spoken English classes?", a: "Most spoken English classes focus only on grammar or conversation practice. ALB combines language learning with communication training, confidence-building, public speaking, interview preparation, workplace communication, and soft skills development through the +Beyond programme." },
    ...
    { q: "Does ALB provide IELTS preparation?", a: "Yes. ALB offers a dedicated IELTS Advantage module covering Listening, Reading, Writing, and Speaking. Students receive strategy training, practice tests, personalised feedback, and mock exams designed to help improve overall band scores." },
    ...
    { q: "Do I need perfect grammar before I start speaking English?", a: "No. One of the biggest misconceptions is that learners must master grammar before speaking. At ALB, learners begin speaking from the start while improving grammar naturally through structured communication practice and feedback." },
    { q: "Why do many learners understand English but struggle to speak it?", a: "This usually happens because learners spend years studying English academically without sufficient speaking practice. ALB focuses on active communication, helping learners convert passive knowledge into real-world speaking ability." },
    ...
    { q: "Will I receive a certificate after completing the programme?", a: "Yes. Learners receive ALB completion certificates at milestone levels. Students pursuing IELTS preparation also receive mock assessment reports and performance feedback throughout the programme." },
...
export const GERMAN: CourseData = {
  ...
  ew: "German · For Study, Career & Global Opportunities",
  ...
  sections: {
    ...
    curriculum: { eyebrow: "The Curriculum", a: "More Than German. ", b: "Skills For Life, Work & Opportunity.", sub: "Every level combines language development, communication practice, exam readiness, and confidence-building. By the time you reach B2, you're prepared not only to use German, but to succeed in German-speaking academic, professional, and everyday environments." },
  ...
  curriculum: [
    { label: "Module 1", title: "German Foundations", badge: "A1 · Goethe A1", weeks: "8 Weeks", desc: "Start from zero and build a strong foundation in German. Learn essential vocabulary, pronunciation, sentence structure, and everyday communication skills needed for basic conversations and real-world interactions.", topics: [
      { t: "Introductions & Personal Information", i: ["Introducing yourself and others", "Nationality, profession, and personal details", "Basic conversation starters", "German pronunciation fundamentals"] },
      { t: "Daily Life & Everyday Communication", i: ["Talking about routines and schedules", "Days, dates, and time expressions", "Family, relationships, and social interactions", "Common everyday vocabulary"] },
      { t: "Shopping, Food & Services", i: ["Ordering food and drinks", "Shopping conversations", "Prices, quantities, and transactions", "Interacting with service providers"] },
      { t: "Travel & Local Navigation", i: ["Asking for and giving directions", "Transportation vocabulary", "Booking tickets and reservations", "Handling common travel situations"] },
    ...
    { label: "Module 2", title: "Everyday Confidence", badge: "A2 · Goethe A2", weeks: "8 Weeks", desc: "Develop the ability to manage everyday situations independently. Learn to communicate in travel, study, work, and administrative environments while building confidence in speaking, listening, reading, and writing.", topics: [
      { t: "Travel, Transport & City Life", i: ["Travel planning and bookings", "Public transportation vocabulary", "Navigating cities and public services", "Handling real-life travel situations"] },
      { t: "Past Experiences & Storytelling", i: ["Talking about past events", "Describing experiences and achievements", "Narrating personal and professional journeys", "Expressing opinions and preferences"] },
      { t: "Health, Housing & Daily Administration", i: ["Healthcare and appointments", "Accommodation and housing vocabulary", "Basic administrative communication", "Understanding common forms and documents"] },
    ...
    { label: "Module 3", title: "Independent Communication", badge: "B1 · Goethe B1", weeks: "10 Weeks", desc: "Build the confidence to communicate independently in academic, professional, and social environments. Develop the ability to express opinions, discuss ideas, and handle real-world German interactions with greater fluency.", topics: [
      { t: "Workplace & Professional Communication", i: ["Meetings and workplace discussions", "Professional introductions and networking", "Business communication fundamentals", "German workplace culture"] },
      { t: "Education & Future Planning", i: ["Academic discussions and presentations", "Study and career planning", "Goal-setting conversations", "University and training pathways"] },
      { t: "Opinions, Discussions & Debate", i: ["Expressing viewpoints confidently", "Agreeing and disagreeing respectfully", "Problem-solving conversations", "Structured discussions and group interaction"] },
    ...
    { label: "Module 4", title: "Advanced Fluency & Opportunity Readiness", badge: "B2 · Goethe B2 / TestDaF / DSH Readiness", weeks: "10 Weeks", desc: "Develop advanced German communication skills for higher education, professional environments, immigration pathways, and international opportunities. Learn to communicate clearly, confidently, and effectively in complex situations.", topics: [
      { t: "Advanced Communication & Fluency", i: ["Complex discussions and negotiations", "Presenting ideas with confidence", "Advanced listening and comprehension", "Natural spoken interaction"] },
      { t: "Academic & Professional German", i: ["Research and academic communication", "Formal presentations", "Professional reports and documentation", "Business correspondence"] },
      { t: "Current Affairs & Critical Thinking", i: ["Social, cultural, and economic topics", "Analysing and discussing complex issues", "Developing structured arguments", "Advanced reading comprehension"] },
    ...
    { label: "Module 5", title: "+Beyond, Global Confidence Programme", badge: "Included With Every Programme", weeks: "2 Weeks", desc: "Go beyond language learning with ALB's signature soft-skills and communication programme. Develop the confidence, professionalism, and communication abilities needed to succeed in academic, professional, and international environments.", topics: [
      { t: "Public Speaking & Presentation Skills", i: ["Speaking confidently in front of groups", "Presentation structure and delivery", "Managing nervousness and hesitation", "Audience engagement techniques"] },
      ...
      { t: "Personal Growth & Confidence", i: ["Building a growth mindset", "Communication under pressure", "Leadership fundamentals", "Professional presence and self-confidence"] },
  ...
  comparison: [
    ...
    { f: "Batch size", g: "20–40 students per class", a: "Small cohorts, real speaking time for everyone" },
    { f: "Communication skills", g: "Grammar and exams only", a: "Dedicated communication & fluency classes" },
    { f: "Exam preparation", g: "Sold as a separate add-on", a: "Goethe, TestDaF & DSH prep built into the journey" },
    { f: "Soft skills", g: "Not included", a: "+Beyond global confidence programme, free" },
    { f: "Doubt support", g: "Only during class", a: "Continuous support between sessions" },
    { f: "Teaching approach", g: "Western textbooks, unchanged", a: "India-first pedagogy, built for Indian learners" },
  ],
  ...
  faq: [
    ...
    { q: "How long does it take to learn German from A1 to B2?", a: "ALB's structured German pathway helps learners progress from A1 to B2 in approximately 36 weeks while developing practical communication skills, exam readiness, and confidence in real-world situations." },
    ...
    { q: "What level of German is required for Germany immigration?", a: "Requirements vary depending on the visa category. Family reunification often requires Goethe A1, while some work and settlement pathways may require B1 or higher. ALB's Immigration Track helps learners prepare for the relevant language requirements." },
    { q: "Which German exam should I take?", a: "The best exam depends on your goal. Goethe-Zertifikat is widely recognised internationally. TestDaF and DSH are commonly required for German university admissions. ALB guides learners toward the exam pathway that matches their objectives." },
    { q: "What level of German is required for studying in Germany?", a: "Many German-taught university programmes require B2, TestDaF, or DSH-level proficiency. Requirements vary by institution and programme. ALB's Academic Track is designed to prepare students for these academic language requirements." },
    ...
    { q: "What makes ALB different from other German institutes?", a: "ALB combines structured German learning with communication classes, soft-skills development, interview readiness, doubt support, exam preparation, and specialised pathways for immigration, academics, careers, and accelerated learning." },
  ],
...
export const SPANISH: CourseData = {
  ...
  tracks: [
    ...
    { icon: "flight", name: "Culture & Travel Track", color: "#7C3AED", pop: false, forText: "Travellers, content lovers, and lifelong learners wanting confident conversational Spanish for Spain, Latin America, film, music, and authentic cultural connection.", exams: ["DELE A2", "DELE B1"] },
    { icon: "star", name: "Junior Track", color: "#D97706", pop: false, forText: "School students building early Spanish proficiency for academic advantage, DELE certifications, and a head start on a globally valuable language.", exams: ["DELE A1", "DELE A2", "DELE B1"] },
  ],
  journey: [
  ...
  usps: [
    { i: "target", t: "Goal-Certified Track System", b: "Four outcome-specific tracks under one programme, Academic, Career, Culture & Travel, and Junior. Your curriculum emphasis and exam focus are tailored from day one." },
...
export const JAPANESE: CourseData = {
  ...
  tracks: [
    { icon: "computer", name: "IT & Tech Track", color: "#BE123C", pop: true, forText: "Indian IT professionals targeting Japan-facing roles, bridge SE, offshore, and onsite positions where N2 Japanese commands a 40–60% salary premium.", exams: ["JLPT N3", "JLPT N2"] },
    ...
    { icon: "movie", name: "Culture & Media Track", color: "#7C3AED", pop: false, forText: "Anime, manga, gaming, and culture lovers wanting to enjoy Japanese media in the original and travel confidently across Japan.", exams: ["JLPT N5", "JLPT N4"] },
    { icon: "star", name: "Junior Track", color: "#D97706", pop: false, forText: "School and college students building strong early Japanese foundations for higher studies, exchange programmes, and future careers.", exams: ["JLPT N5", "JLPT N4"] },
  ],
  journey: [
  ...
  usps: [
    { i: "target", t: "Goal-Certified Track System", b: "Four outcome-specific tracks under one programme, IT & Tech, Work in Japan, Culture & Media, and Junior. Your curriculum emphasis and exam focus are tailored from day one." },
    { i: "translate", t: "Scripts & Kanji Without the Fear", b: "Kana in weeks, kanji built progressively with radicals and mnemonics. The writing system stops being a wall and becomes a system you actually understand." },
    { i: "computer", t: "IT & Business Japanese, Built In", b: "Bridge-SE vocabulary, keigo, and business documents are part of the upper levels, the exact Japanese that Japan-facing roles actually demand." },
    { i: "people", t: "Max 6 Per Batch, Always", b: "Speaking time, feedback, and instructor attention are never diluted. You are not a face in a row of thirty." },
  ],
  comparison: [
...
export const KOREAN: CourseData = {
  ...
  tracks: [
    ...
    { icon: "star", name: "Junior Track", color: "#D97706", pop: false, forText: "School and college students building early Korean foundations for higher studies, exchange programmes, and future opportunities in Korea.", exams: ["TOPIK I", "Beginner"] },
  ],
  journey: [
