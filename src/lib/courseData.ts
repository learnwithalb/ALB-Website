...
export const ENGLISH: CourseData = {
  ...
  tracks: [
    { icon: "flight", name: "Immigration Track", color: "#059669", pop: true, forText: "Canada, UK, and Australia PR applicants and work visa holders needing IELTS, PTE, or TOEFL scores for Express Entry, skilled worker visas, and settlement.", exams: ["IELTS General", "PTE", "TOEFL"] },
    { icon: "school", name: "Academic Track", color: "#7C3AED", pop: false, forText: "Students applying to international universities, UK, USA, Canada, Australia, needing IELTS Academic 6.5+ or equivalent PTE/TOEFL scores for admission.", exams: ["IELTS Academic", "PTE Academic", "TOEFL"] },
    { icon: "work", name: "Career Track", color: "#2563EB", pop: false, forText: "Working professionals at MNCs, BPOs, and global companies needing professional-grade English for client communication, presentations, and leadership roles.", exams: ["IELTS General", "PTE"] },
    { icon: "star", name: "Junior Track", color: "#D97706", pop: false, forText: "School students building strong English foundations for academic excellence, competitive exams, and early preparation for university or immigration goals.", exams: ["IELTS", "School prep", "Competitive exams"] },
  ],
  journey: [
